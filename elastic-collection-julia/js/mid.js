...
// clicking on filter by pop
    ...
    filterC.addEventListener("click", function() {
      if (shadowContainer.classList.contains("charles.h")) {
        shadowContainer.style.visibility = 'visible';
      } else {
        shadowContainer.style.visibility = 'hidden';
      }
    ...
    var filterCc = document.querySelector(".filter3");
    filterCc.addEventListener("click", function() {
      if (shadowContainer.classList.contains("charles.w")) {
        shadowContainer.style.visibility = 'visible';
      } else {
        shadowContainer.style.visibility = 'hidden';
      }
    ...
    var filterE = document.querySelector(".filter4");
    filterE.addEventListener("click", function() {
      if (shadowContainer.classList.contains("east")) {
        shadowContainer.style.visibility = 'visible';
      } else {
        shadowContainer.style.visibility = 'hidden';
      }
    ...
    var filterF = document.querySelector(".filter5");
    filterF.addEventListener("click", function() {
      if (shadowContainer.classList.contains("f")) {
        shadowContainer.style.visibility = 'visible';
      } else {
        shadowContainer.style.visibility = 'hidden';
      }
    ...
    var filterG = document.querySelector(".filter6");
    filterG.addEventListener("click", function() {
      if (shadowContainer.classList.contains("george")) {
        shadowContainer.style.visibility = 'visible';
      } else {
        shadowContainer.style.visibility = 'hidden';
      }
    ...
    var filterGg = document.querySelector(".filter7");
    filterGg.addEventListener("click", function() {
      if (shadowContainer.classList.contains("gordon")) {
        shadowContainer.style.visibility = 'visible';
      } else {
        shadowContainer.style.visibility = 'hidden';
      }
    ...
    var filterL = document.querySelector(".filter8");
    filterL.addEventListener("click", function() {
      if (shadowContainer.classList.contains("leonard")) {
        shadowContainer.style.visibility = 'visible';
      } else {
        shadowContainer.style.visibility = 'hidden';
      }
    ...
    var filterLl = document.querySelector(".filter9");
    filterLl.addEventListener("click", function() {
      if (shadowContainer.classList.contains("life")) {
        shadowContainer.style.visibility = 'visible';
      } else {
        shadowContainer.style.visibility = 'hidden';
      }
    ...
    var filterS = document.querySelector(".filter10");
    filterS.addEventListener("click", function() {
      if (shadowContainer.classList.contains("slim")) {
        shadowContainer.style.visibility = 'visible';
      } else {
        shadowContainer.style.visibility = 'hidden';
      }
    ...
    var filterSs = document.querySelector(".filter11");
    filterSs.addEventListener("click", function() {
      if (shadowContainer.classList.contains("stanley")) {
        shadowContainer.style.visibility = 'visible';
      } else {
        shadowContainer.style.visibility = 'hidden';
      }
    ...
    var filterU = document.querySelector(".filter12");
